...
:uri-github-mempang23-certificate: https://github.com/AndreaGuarracino/cv/blob/main/certificates/MemPanG23_CertificateOrganizerAndInstructor_AndreaGuarracino.pdf
...
| *Instructor* and *organizer*, created new material and tutorials, held some lessons, assisted the participants, configured the virtual machines

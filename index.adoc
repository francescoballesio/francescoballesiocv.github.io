...
icon:book[] Thesis title: "Investigating chromosomal instability in cancer stem cells". Evaluation: excellent quality.
...
co-regulation of protein interaction". Evaluation: 110/110 cum laude; GPA: 4.00, A+.
...
== icon:search[] Reviewer for international journals
...
== icon:bullhorn[] Abstracts / Talks / Posters
...
| Parallelization of a bottleneck in the graph induction, bug fixings, experiments in multiple species
...
| Made Figure 6.a, 7.a, and 7.b, contributed for Figure 6.c,
6.e, performed RNA-seq, ATAC-seq, and microarray data analysis, correlation analyses,
TF-binding motif enrichment, survival analyses
| icon:book[] {uri-musella2022}[Publication]

| `13 May 2022` +
| Bioinformatics
| **ODGI: understanding pangenome graphs*
| Wrote the draft paper and the documentation, made the figures and the table, implemented several tools
| icon:book[] {uri-guarracino2022-odgi}[Publication]
...
| icon:book[] {uri-pepe2022}[Publication]

| `26 May 2021` +
| Nucleic Acids Research
| **BRIO: a web server for RNA sequence and structure motif scan*
| Wrote the paper, made the figures and the table, refactored and completed the web
server, refined the datasets
| icon:book[] {uri-guarracino2021-brio}[Publication] +
  icon:globe[] {uri-guarracino2021-brio-webserver}[Webserver] +
  icon:github[] {uri-github-brio}[Repository] +
  icon:file-pdf-o[] {uri-guarracino2021-brio-graphical-abstract}[Graphical abstract] +
...
| icon:book[] {uri-ferrarini2021}[Publication] +
...
| Made Figure 1.A, helped in analyzing survival data
| icon:book[] {uri-mattiello2021}[Publication]

| `24 March 2021` +
| Cell Death & Disease
| Inhibition of HECT E3 ligases as potential therapy for COVID-19
| Made Figure 4, provided _in silico_ 3D structures analysis
| icon:book[] {uri-novelli2021}[Publication]
...
| icon:book[] {uri-pietrosanto-adinolfi-guarracino2021-rig}[Publication] +
...
| icon:book[] {uri-manic2021}[Publication]

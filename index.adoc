...
| Advanced Bioinformatics: Data Mining and Data Integration for Life Science, Master’s degree, {utrecht-bioinformatics-center} (Utrecht, Netherlands)
...
| Nature, _In principle accepted_

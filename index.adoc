...
icon:file-pdf-o[] {uri-ctc-rg-2023-certificate}[Certificate - STILL MISSING]
...
| English Speaking Board (EBS) Level 1, Pass with distinction
| icon:file-pdf-o[] {uri-english-language-certification-certificate}[Certificate]

| `27 Sept. 2017 to 29 Sept. 2017` +
| {university-salerno}
| {uri-best-practices-RNA-seq}[Best practices for RNA-Seq data analysis - ELIXIR-IIB]

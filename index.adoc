...
:uri-github-t2t-f2f-presentation: https://andreaguarracino.github.io/posters/T2T24_FormationTransmissionRobChrs_Presentation_AndreaGuarracino.pdf
:uri-github-hprc24-presentation: https://andreaguarracino.github.io/posters/HPRC24_LessonsFromAmylaseLocus_Presentation_AndreaGuarracino.pdf
...
| icon:spinner[] {uri-garrison2024}[Paper]
...
| {uri-t2t-2f2}[Telomere-to-Telomere "Face-to-Face" (T2T-F2F) 2024]

...
:uri-github-romepang24-certificate: https://github.com/AndreaGuarracino/cv/blob/main/certificates/RomePanG24_CertificateOrganizerInstructor_AndreaGuarracino.pdf
...
* Pangenome graph sorting and layout (icon:spinner[] {uri-heumos2024}[Heumos*, Guarracino* _et al._, 2023, bioRxiv])
...
icon:file-pdf-o[] {uri-github-romepang24-certificate}[MISSING]
...
| {uri-sbme24-call-for-abstracts}[Call for abstracts]
|===

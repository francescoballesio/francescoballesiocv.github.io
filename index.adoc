...
:uri-italian-iigm: https://www.iigm.it/
...
:iigm: {uri-italian-iigm}[Italian Institute for Genomic Medicine]
...
icon:calendar[] `Nov. 2019 to Present` +
icon:university[] *Collaboration with the {iigm}* (Candiolo, Italy). +
